...
public class Pause1 extends AppCompatActivity {
    private Button mPause1;//création des variables de type bouton
    private Button mStart1;
    private TextView mTextTimer1;//création des variables de type textView
    ProgressBar mProgressBar1;//création d'une variable de type ProgressBar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressBar1=(ProgressBar)findViewById(R.id.progress_timer1);// liasion des variables aux ID que l'on souhaite
        ...
        mProgressBar1.getProgressDrawable().setColorFilter(Color.BLUE, PorterDuff.Mode.SRC_IN); // change la couleur de la ProgressBar en bleu
        ...
        mPause1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {// bouton passage entre les activités
                ...
                mProgressBar1.setProgress(0);// on remets la valeur de ProgressBar à 0
            }
        });
    ...
    public void startTimer(){// la boucle qui va lancer le timer puis le mantenir en fonctionnement jusqu'au le moment que le temps s'écoule ou on appuie sur un autre bouton
        On=1;
        mStart1.setText("Pause");// on ecrit "Pause" sur le bouton
        mCountDownTimer = new CountDownTimer(millisOnTimer,updateTimer) { // CountDownTimer, une fonction de base de Android Studio. Il fonctionne pendent millisOnTimer temps, et refait le cycle onTick tout les updateTimer millisecondes.
            ...
            public void onTick(long millisUntilFinished) {// onTick, qui s'execute tout les updateTimer secondes
                ...
                mProgressBar1.incrementProgressBy((int)increase);// fonction de ProgressBar qui augmente la valeur de ProgressBar de tant (increase ici)
            ...
            public void onFinish() {
                On=0;
                mStart1.setText("Start"); // on écrit "Start" sur le bouton
                mProgressBar1.setProgress(100);// une fois que le temps s'est écoulé, on doit avoir ProgressBar remplie à 100%
            }
