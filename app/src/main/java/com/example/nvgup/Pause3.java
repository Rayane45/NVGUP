...
public class Pause3 extends AppCompatActivity {
    private Button mPause3;//création des variables de type bouton
    private Button mStart3;
    private TextView mTextTimer3;//création des variables de type textView
    ProgressBar mProgressBar3;//création d'une variable de type ProgressBar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressBar3=(ProgressBar)findViewById(R.id.progress_timer3);// liasion des variables aux ID que l'on souhaite
        mStart3=(Button)findViewById(R.id.timer_start_stop3);
        mPause3=(Button)findViewById(R.id.Pause3);
        mTextTimer3=(TextView)findViewById(R.id.timer_txt3);
        mProgressBar3.getProgressDrawable().setColorFilter(Color.BLUE, PorterDuff.Mode.SRC_IN); // change la couleur de la ProgressBar en bleu
        ...
        mPause3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {// bouton passage entre les activités
                ...
                mProgressBar3.setProgress(0);// on remets la valeur de ProgressBar à 0
            }
        });
    ...
    public void startTimer(){// la boucle qui va lancer le timer puis le mantenir en fonctionnement jusqu'au le moment que le temps s'écoule ou on appuie sur un autre bouton
        On=1;
        mStart3.setText("Pause");// on ecrit "Pause" sur le bouton
        mCountDownTimer = new CountDownTimer(millisOnTimer,updateTimer) { // CountDownTimer, une fonction de base de Android Studio. Il fonctionne pendent millisOnTimer temps, et refait le cycle onTick tout les updateTimer millisecondes.
            ...
            public void onTick(long millisUntilFinished) {// onTick, qui s'execute tout les updateTimer secondes
                ...
                mProgressBar3.incrementProgressBy((int)increase);// fonction de ProgressBar qui augmente la valeur de ProgressBar de tant (increase ici)
            ...
            public void onFinish() {
                On=0;
                mStart3.setText("Start"); // on écrit "Start" sur le bouton
                mProgressBar3.setProgress(100);// une fois que le temps s'est écoulé, on doit avoir ProgressBar remplie à 100%
            }
    ...
    public void updateCountDownText(){
        ...
        if (seconds>9 && minutes>9) {
            ...
            mTextTimer3.setText(timeLeftFormatted); // on mets ce texte dans l'endroit dedié
        }
            ...
            // % est le symbole de debut de format, 0%1 sert a definir la longeur (%1) et le 0 sert a l'afficher, même si la valeur de secondes ou minutes n'as pas 2 chiffres
            // d est le decimal ( pour float c'est f, par exemple)
            mTextTimer3.setText(timeLeftFormatted);
        }
        else{
